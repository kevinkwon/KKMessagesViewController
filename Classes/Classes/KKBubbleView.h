...
/**
 *  An instance of KKBubbleView is a means for displaying text in a speech bubble image to be placed in a KKBubbleMessageCell. 
 *  @see KKBubbleMessageCell.
 */
@interface KKBubbleView : UIView

/**
 *  The message type for this bubble view.
 *  @see KKBubbleMessageType for descriptions of the constants used to specify bubble message type.
 */
@property (assign, nonatomic, readonly) KKBubbleMessageType type;
 ...
 *  @param bubleType       A constant that specifies the type of the bubble view. @see KKBubbleMessageType.
 *  @param bubbleImageView An image view initialized with an image and highlighted image for this bubble view. @see KKBubbleImageViewFactory.
 *
 *  @return An initialized `KKBubbleView` object or `nil` if the object could not be successfully initialized.
 */
- (instancetype)initWithFrame:(CGRect)frame
                   bubbleType:(KKBubbleMessageType)bubleType
