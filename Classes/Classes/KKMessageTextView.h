...
#import "KKDismissiveTextView.h"

/**
 *  An instance of `KKMessageTextView` is a means for displaying an input text view above a keyboard as a subview of a keyboard's `inputAccessoryView`. It is used for composing messages and adds support for a placeholder like UITextField.
 */
@interface KKMessageTextView : KKDismissiveTextView
