...
/**
 *  The `KKBubbleMessageCell` class defines the attributes and behavior of the cells that appear in `KKMessagesViewController`. This class includes properties and methods for setting and managing cell content.
 */
@interface KKBubbleMessageCell : UITableViewCell

/**
 *  Returns the bubble view used in the cell. KKBubbleMessageCell adds the appropriate bubble view when you create the cell with a given cell type and bubbleImageView. This property is never `nil`. 
 *  @see KKBubbleView. 
 *  @see KKBubbleMessageType.
 */
@property (weak, nonatomic, readonly) KKBubbleView *bubbleView;

/**
 *  Returns the label used to display the timestamp for the cell. This property may be `nil` if no timestamp is provided. 
 *  @see KKMessagesViewDataSource.
 */
 ...
 *
 *  @param type            A constant indicating a message type. @see KKBubbleMessageType for details.
 *  @param bubbleImageView An image view initialized with bubble images. The `UIImageView` properties `image` and `highlightedImage` must not be `nil`. @see KKBubbleImageViewFactory.
 ...
 *  @param reuseIdentifier A string used to identify the cell object to be reused for drawing multiple rows of a KKMessagesViewController. This property must not be `nil`.
 *
 *  @return An initialized `KKBubbleMessageCell` object or `nil` if the object could not be created.
 */
...
/**
 *  Sets the date to be displayed in the timestampLabel of the cell. The date is formatted for you via `NSDateFormatter` by `KKBubbleMessageCell`.
 *
...
/**
 *  Sets the imageView for the avatarImageView of the cell. The frame is set for you by `KKBubbleMessageCell`.
 *
